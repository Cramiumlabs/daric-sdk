/**
 ******************************************************************************
 * @file    daric_udma_spim_v3.h
 * @author  SPIM Team
 * @brief   Header file of SPIM HAL module.
 ******************************************************************************
 * @attention
 *
...
// #define SPI_CMD_SEND_ADDR_VALUE(value)  ((((value) & 0xff000000) >> 24) |
// (((value) & 0xff0000) >> 8) | (((value) & 0xff00) << 8) | (((value) & 0xff)
// << 24))
...
#define SPI_CMD_CFG(clockDiv, cpol, cpha) \
    ((SPI_CMD_CFG_ID << SPI_CMD_ID_OFFSET) | ((cpol) << SPI_CMD_CFG_CPOL_OFFSET) | ((cpha) << SPI_CMD_CFG_CPHA_OFFSET) | ((clockDiv) << SPI_CMD_CFG_CLK_DIV_OFFSET))
#define SPI_CMD_SOT(cs) ((SPI_CMD_SOT_ID << SPI_CMD_ID_OFFSET) | ((cs) << SPI_CMD_SOT_CS_OFFSET))
#define SPI_CMD_SEND_CMD(cmd, bits, qpi) \
    ((SPI_CMD_SEND_CMD_ID << SPI_CMD_ID_OFFSET) | ((qpi) << SPI_CMD_SEND_CMD_QPI_OFFSET) | (((bits) - 1) << SPI_CMD_SEND_CMD_SIZE_OFFSET) | (cmd & 0xFFFF))
#define SPI_CMD_SEND_BITS(data, bits, qpi) \
    ((SPI_CMD_SEND_CMD_ID << SPI_CMD_ID_OFFSET) | ((qpi) << SPI_CMD_SEND_CMD_QPI_OFFSET) | (((bits) - 1) << SPI_CMD_SEND_CMD_SIZE_OFFSET) | (data & 0xFFFF))
...
#define SPI_CMD_SETUP_UCS(txrxen, ds, size) \
    ((SPI_CMD_SETUP_UCS_ID << SPI_CMD_ID_OFFSET) | ((txrxen) << SPI_CMD_SETUP_UC_TXRXEN_OFFSET) | ((ds) << SPI_CMD_SETUP_UC_DS_OFFSET) | (size & 0xFFFF))
#define SPI_CMD_TX_DATA(words, wordstrans, bitsword, qpi, lsbfirst)                                                                                                         \
    ((SPI_CMD_TX_DATA_ID << SPI_CMD_ID_OFFSET) | (((unsigned int)(qpi)) << SPI_CMD_TX_DATA_QPI_OFFSET) | (((unsigned int)(wordstrans)) << SPI_CMD_TX_DATA_WORDTRANS_OFFSET) \
     | ((bitsword - 1) << SPI_CMD_TX_DATA_BITSWORD_OFFSET) | (((words) - 1) << SPI_CMD_TX_DATA_SIZE_OFFSET) | ((lsbfirst) << SPI_CMD_TX_DATA_LSBFIRST_OFFSET))
#define SPI_CMD_RX_DATA(words, wordstrans, bitsword, qpi, lsbfirst)                                                                                                         \
    ((SPI_CMD_RX_DATA_ID << SPI_CMD_ID_OFFSET) | (((unsigned int)(qpi)) << SPI_CMD_RX_DATA_QPI_OFFSET) | (((unsigned int)(wordstrans)) << SPI_CMD_RX_DATA_WORDTRANS_OFFSET) \
     | ((bitsword - 1) << SPI_CMD_RX_DATA_BITSWORD_OFFSET) | (((words) - 1) << SPI_CMD_RX_DATA_SIZE_OFFSET) | ((lsbfirst) << SPI_CMD_RX_DATA_LSBFIRST_OFFSET))
#define SPI_CMD_RPT(iter) ((SPI_CMD_RPT_ID << SPI_CMD_ID_OFFSET) | ((iter) << SPI_CMD_RPT_NB_OFFSET))

#define SPI_CMD_EOT(evt, cs_keep) ((((unsigned int)SPI_CMD_EOT_ID) << 28) | ((evt) << SPI_CMD_EOT_GEN_EVT_OFFSET) | (((unsigned int)(cs_keep)) << SPI_CMD_EOT_CS_KEEP_OFFSET))

#define SPI_CMD_RX_CHECK(mode, bits, value, qpi, byte_align)                                                                            \
    ((SPI_CMD_RX_CHECK_ID << SPI_CMD_ID_OFFSET) | ((value) << SPI_CMD_RX_CHECK_VALUE_OFFSET) | ((mode) << SPI_CMD_RX_CHECK_MODE_OFFSET) \
     | (((bits) - 1) << SPI_CMD_RX_CHECK_SIZE_OFFSET) | ((byte_align) << SPI_CMD_RX_CHECK_BYTE_ALIGN_OFFSET) | ((qpi) << SPI_CMD_RX_CHECK_QPI_OFFSET))
...
#define SPI_CMD_FUL(words, wordstrans, bitsword, lsbfirst)                                                                  \
    ((((unsigned int)SPI_CMD_FUL_ID) << SPI_CMD_ID_OFFSET) | (((unsigned int)(wordstrans)) << SPI_CMD_FUL_WORDTRANS_OFFSET) \
     | ((unsigned int)((bitsword - 1)) << SPI_CMD_FUL_BITSWORD_OFFSET) | (((words) - 1) << SPI_CMD_FUL_SIZE_OFFSET) | ((lsbfirst) << SPI_CMD_FUL_LSBFIRST_OFFSET))
