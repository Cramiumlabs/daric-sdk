/**
 ******************************************************************************
 * @file    nandW25N01_filexLevelx_app.h
 * @author  OS Team
...
#ifndef _NANDW25N01_FILEXLEVELX_APP_H_
#define _NANDW25N01_FILEXLEVELX_APP_H_
...
extern LX_NAND_FLASH gNandflashLevelx;
 ...
 * relevant settings.
 */
extern  uint32_t appNandFlashFilexLevelxDiskLoad(void);
 ...
 */
extern uint32_t appNandFlashFilexLevelxDiskP1Format(void);
 ...
 * before calling this interface.
 */
extern uint32_t appNandFlashFilexLevelxDiskP2Format(void);
 ...
 */
extern uint32_t appNandFlashLevelxInit(void);
