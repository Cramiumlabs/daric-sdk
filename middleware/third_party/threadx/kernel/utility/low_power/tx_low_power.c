...
#define TX_LOW_POWER_TIMER_SETUP(time) low_power_timer_config(time)
#define TX_LOW_POWER_USER_ENTER low_power_user_enter()
#define TX_LOW_POWER_USER_EXIT low_power_user_exit()
#define TX_LOW_POWER_USER_TIMER_ADJUST low_power_timer_adjust()

#ifdef DEVDBG
#define LP_LOG(format, ...) printf(format, ##__VA_ARGS__)
#else
#define LP_LOG(format, ...)
#endif
