...
#define AW_RAMDATA_RD_BUFFER_SIZE			(128) /* 1024 */
#define AW_RAMDATA_WR_BUFFER_SIZE			(128) /* 2048 */
...
#if defined (CONFIG_AW862XX_DRIVER) || defined (CONFIG_AW8623X_DRIVER) || defined (CONFIG_AW8624X_DRIVER)
